...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //5首歌歌名
        namelist.add("Little GrassShack");
        namelist.add("Jingle Bell");
        namelist.add("Into the Unknown sell");
        namelist.add("Buck break");
        namelist.add("Oh Radian One s");
        //5个艺术家名
        artistlist.add("Voodoo Suite");
        artistlist.add("Scott Holmes");
        artistlist.add("Marrten");
        artistlist.add("Ken Ham");
        artistlist.add("Siddharth");
        //歌曲对应的url
        ...
        String url2="https://freemusicarchive.org/music/thetunefulquire/gombori-om/gombori-ommp3";
